...
\label{tab:noise}
\input{../results/full_scale/tex/table_semantic_noise.tex}
\end{table}
...
\label{tab:topk}
\input{../results/full_scale/tex/table_witness_ordering.tex}
\end{table}
...
\label{tab:friction}
\input{../results/full_scale/tex/table_friction_model.tex}
\end{table}
...
\label{tab:claim-map}
\input{../results/full_scale/tex/table_claim_evidence.tex}
\end{table}
